...
LABEL org.opencontainers.image.source="https://github.com/serpro69/pal-mcp-server"
LABEL org.opencontainers.image.documentation="https://github.com/serpro69/pal-mcp-server/blob/main/README.md"
